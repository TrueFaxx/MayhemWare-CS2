...
public static class Utility
{
    ...
    private static ProcessModule GetProcessModule(this System.Diagnostics.Process process, string moduleName)
    {
    ...
    public static void MouseLeftDown()
    {
        ...
        inputs[0] = new Input
        {
            ...
            Union = new InputUnion
            {
                mouse = new MouseInput { flags = MouseFlags.LeftDown }
            }
        };
        User32.SendInput((uint)inputs.Length, inputs, Marshal.SizeOf(typeof(Input)));
    }
    ...
    public static void MouseLeftUp()
    {
        ...
        inputs[0] = new Input
        {
            ...
            Union = new InputUnion
            {
                mouse = new MouseInput { flags = MouseFlags.LeftUp }
            }
        };
        User32.SendInput((uint)inputs.Length, inputs, Marshal.SizeOf(typeof(Input)));
    }
    ...
    // Write method (extension) - must be inside static class, with 'this' parameter
    public static void Write<T>(this System.Diagnostics.Process process, IntPtr lpBaseAddress, T value) where T : unmanaged
    {
        var size = Marshal.SizeOf<T>();
        ...
        try
        {
            ...
            Kernel32.WriteProcessMemory(process.Handle, lpBaseAddress, ptr, size, out _);
        }
        finally
        {
